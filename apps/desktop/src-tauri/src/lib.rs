...
pub fn builder() -> tauri::Builder<tauri::Wry> {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::game_paths,
            commands::set_game_staging_root,
            commands::pick_game_staging_root,
            commands::reset_game_staging_root,
            commands::game_icon,
            commands::download_paths,
            commands::pick_download_root,
            commands::reset_download_root,
            commands::mod_contents,
            commands::browse_mod_files,
            commands::fetch_mod,
